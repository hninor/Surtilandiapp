...
public class EntityType extends ODataType {
    ...
    /** Is there Date data types in this entity? */
    private boolean hasDates;

    /** Is there any Index data types in this entity? */
    private boolean hasIndexes;

    /** Is there any NotNull data types in this entity? */
    ...
    /**
     * Returns true if the entity holds any Date data types.
     *
     * @return True if the entity holds any Date data types, false otherwise.
     */
    ...
    /**
     * Sets True if the entity has Date data types.
     *
     * @param hasDates
     *            True if the entity has Date data types, false otherwise.
     */
    ...
    /**
     * Returns true if the entity holds any index.
     *
     * @return True if the entity holds any index, false otherwise.
     */
    ...
    /**
     * Sets True if the entity has indexes.
     *
     * @param hasIndexes
     *            True if the entity has indexes, false otherwise.
     */
    ...
    /**
     * Returns true if the entity holds any properties with the NotNull modifier.
     *
     * @return True if the entity holds any properties with the NotNull modifier, false otherwise.
     */
    public boolean hasNotNulls() {
        return hasNotNulls;
    }

    /**
     * Sets True if the entity has NotNull properties.
     *
     * @param hasNotNulls
     *            True if the entity has NotNull properties, false otherwise.
     */
    public void setHasNotNulls(boolean hasNotNulls) {
        this.hasNotNulls = hasNotNulls;
    }
}

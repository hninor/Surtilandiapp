...
public class MetadataReader extends DefaultHandler {
    ...
    public void startDocument() throws SAXException {
        registeredComplexTypes = new HashMap<>();
        registeredEntityTypes = new HashMap<>();
        registeredAssociations = new HashMap<>();
        registeredEntitySets = new HashMap<>();
        registeredNamespaces = new ArrayList<>();
        ...
        if ("schema".equalsIgnoreCase(localName)) {
            ...
            if (getState() == State.ENTITY_TYPE_KEY) {
                if (currentEntityType.getKeys() == null) {
                    currentEntityType.setKeys(new ArrayList<>());
                }

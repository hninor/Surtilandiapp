...
public class Service {
     ...
     */
    public Service(Reference serviceRef, String user, String password) {
    	if (user != null && password != null && !user.equals("")
				&& !password.equals("")) {
			setCredentials(new ChallengeResponse(
    	...
    	try {
            ...
            cr.setChallengeResponse(getCredentials());
     ...
     */
    public Service(String serviceUri, String user, String password) {
        this(new Reference(serviceUri),user,password);
    }
    ...
    public <T> Query<T> createQuery(String subpath, Class<T> entityClass) {
        return new Query<>(this, subpath, entityClass);
    }
        ...
        if (serverVersion == null) {
            ...
            if (this.latestResponse != null) {
                ...
                if (o != null) {
                    ...
                    if (strHeader != null) {
                        HeaderReader<Object> reader = new HeaderReader<>(
                                strHeader);
